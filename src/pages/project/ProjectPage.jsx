  ...
  return (
    <section className="section__projects section__padding">
      ...
      <div className="section__projects-description">
        <Fade bottom>
          <p>
             Here are some personal projects I worked on which I found challenging and have
             helped level up my skills to an amazing point that I feel confident in tackling 
