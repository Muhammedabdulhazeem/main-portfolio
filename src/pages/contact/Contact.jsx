      ...
      <section className="contact-section">
        ...
        <form ref={form} className="contact-form" onSubmit={onSubmit}>
          <div>
            ...
            <Fade bottom>
              <p>
                I'm available to work on projects any time. If you have
                a job offer for me, kindly fill the form below to reach out.
              </p>
            </Fade>
          </div>
          <Fade bottom>
          ...
          <Reveal bottom>
            <footer className="footer">
              <p> &copy; copyright All Right Reserved Abdulhazeem - 2022</p>
            </footer>
          </Reveal>
        </form>
